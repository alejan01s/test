...
/**
 * Created by aleja on 03/09/2017.
 */

@Autonomous (name = "Red Second-First Beacon", group = "Sensor")
public class autonomousSecondBeaconFirst extends OpMode{
